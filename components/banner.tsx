...
export function Banner({ defaultOpen, onDismiss }: Props) {
  ...
  return (
    <div className="relative full text-xs border border-dashed border-yellow-500 bg-yellow-100 py-2 pl-2 pr-8">
      ...
      coding agent built with Vercel&apos;s AI Cloud, AI SDK, and Next.js. Code
      execution is now orchestrated through Trigger.dev workflows running on
      top of E2B sandboxes to preserve the original Vibe experience. For a
      drop-in, higher-level solution for adding vibe coding capabilities to your
      applications, check out the v0 Platform API.
      <button
